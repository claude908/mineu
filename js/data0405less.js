...
const infoList = [
  {
    name: '',
    desc: 'Different strokes for different folks: Try this starter routine<br>ENTJ 상품추천'
  },
  {
    name: '',
    desc: 'Different strokes for different folks: Try this starter routine<br>ENTP 상품추천'
  },
  {
    name: '',
    desc: 'Different strokes for different folks: Try this starter routine<br>ENFJ 상품추천'
  },
  {
    name: '',
    desc: 'Different strokes for different folks: Try this starter routine<br>ENFP 상품추천'
  },
  {
    name: '',
    desc: 'Different strokes for different folks: Try this starter routine<br>ESTJ 상품추천'
  },
  {
    name: '',
    desc: 'Different strokes for different folks: Try this starter routine<br>ESTP 상품추천'
  },

  {
    name: '',
    desc: 'Different strokes for different folks: Try this starter routine<br>ESFJ 상품추천'
  },
  {
    name: '',
    desc: 'Different strokes for different folks: Try this starter routine<br>ESFP 상품추천'
  },
  {
    name: '',
    desc: 'Different strokes for different folks: Try this starter routine<br>INTJ 상품추천'
  },
  {
    name: '',
    desc: 'Different strokes for different folks: Try this starter routine<br>INTP 상품추천'
  },
  {
    name: '',
    desc: 'Different strokes for different folks: Try this starter routine<br>INFJ 상품추천'
  },
  {
    name: '',
    desc: 'Different strokes for different folks: Try this starter routine<br>INFP 상품추천'
  },
  {
    name: '',
    desc: 'Different strokes for different folks: Try this starter routine<br>ISTJ 상품추천'
  },
  {
    name: '',
    desc: 'Different strokes for different folks: Try this starter routine<br>ISTP 상품추천'
  },
  {
    name: '',
    desc: 'Different strokes for different folks: Try this starter routine<br>ISFJ 상품추천'
  },
  {
    name: '',
    desc: 'Different strokes for different folks: Try this starter routine<br>ISFP 상품추천'
  },
