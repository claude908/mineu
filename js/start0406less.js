...
const preGrid = document.querySelector(".pre-grid")
function calcResult(){
    var pointArray = [
...
/*         const resultName = document.querySelector('.resultName');   //Currently not used but bring back and add animation
        ...
        for(i=0; i<2; i++){
            ...
            if(i == 0){
                ...
                console.log(rndInt);
                var imgURL = 'https://seattle81.cdn3.cafe24.com/images/mbti/' + point + rndInt + '.png';
            }
            if(i == 1){
                var imgURL = 'https://seattle81.cdn3.cafe24.com/images/mbti/' + point + '0' + '.png';
            }
            ...
            resultImg.classList.add('point' + i + point);
